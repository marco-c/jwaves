...
(function (self) {
  ...
  var oghliner = self.oghliner = {
    ...
    CACHE_PREFIX: 'offline-cache:marco-c/jwaves:' + (self.registration ? self.registration.scope : '') + ':',

    // This is the unique name for the cache controlled by this version of the worker.
    get CACHE_NAME() {
      return this.CACHE_PREFIX + '26286374fdb4abc0e5d13bcdcdcc1a1c5857bef5';
    },

    // This is a list of resources that will be cached.
    RESOURCES: [
      './', // cache always the current root to make the default page available
      './index.html', // 092d57e993defb8042e9f024c774b69296efe2ed
